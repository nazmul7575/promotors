...
var ScrollReveal = (function () {
		...
		function e(e, t) {
			if ((void 0 === t && (t = i), e && "string" == typeof e)) {
				...
				throw new RangeError(
					'Unable to find "' + e + '" style property.'
				);
			}
	...
	function p(e) {
		...
		i.rotate.x &&
			...
			1 !== i.scale &&
				(0 === i.scale ? j.push(D(2e-4)) : j.push(D(i.scale)));
		var R = {};
		if (j.length) {
		...
		(this.head = []),
			...
			this.body.length &&
				f(e.members, function (e, t) {
					...
					n &&
						!n[i] &&
						(t < o.body[0] ? o.head.push(t) : o.foot.push(t));
				});
	}
	function j(e, t, n, i) {
		var r = this,
	...
	function i(e, a, t) {
		...
		try {
			...
			f(
				...
				function (e) {
					(c.store.elements[e.id] = e).node.setAttribute(
						"data-sr-id",
						e.id
					);
				}
	...
	function H(e) {
		...
		try {
			...
			return (
				h.call(this, "Invalid configuration.", e.message), n.failure()
			);
		}
		try {
